...
class Enemy:
    ...
    def __init__(self, fila: int, columna: int) -> None:
        ...
        self.velocidad = 2  # Un poco más lento que el jugador para jugabilidad
    ...
    def actualizar(self, cuadricula, posicion_jugador: tuple[int, int], algoritmo: str) -> None:
        ...
        if not self.moviendose:
            ...
            # Recalcular la ruta matemática usando la Lista de Adyacencia del Grafo
        ...
        if self.moviendose and self.destino_celda:
            ...
            # Movimiento puramente ortogonal (un eje a la vez)
            if diferencia_x != 0:
